...
-- Dumping data for table posmia.item_penjualan: ~7 rows (approximately)
...
INSERT INTO `jenis` (`id`, `user_id`, `nama_jenis`, `created_at`, `updated_at`) VALUES
	...
	(8, 7, 'Hijab', '2026-09-11 02:11:46', '2026-09-11 02:11:46');
...
-- Dumping data for table posmia.migrations: ~10 rows (approximately)
...
-- Dumping data for table posmia.penjualan: ~7 rows (approximately)
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `uang_diterima`, `kembalian`, `status`, `created_at`, `updated_at`) VALUES
	...
	(12, 10, 0, 'CASH', NULL, NULL, 'OPEN', '2026-09-11 02:16:55', '2026-09-11 02:16:55');
...
-- Dumping data for table posmia.produk: ~7 rows (approximately)
INSERT INTO `produk` (`id`, `user_id`, `foto`, `nama`, `jenis_id`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	...
	(9, 7, 'products/Ku286DFYgDLdGXOLlf6hH8IYegbAnohBdPApqgyc.jpg', 'Adidas Samba OG Lucid Pink Cream', 3, 5000000, 7000000, 996, '2026-09-01 07:21:55', '2026-09-11 02:15:44'),
	(10, 7, 'products/9aLeuqRStkKC368CgPKEeMmovwHoNfc1AzkBkERk.jpg', 'Adidas Sneakers', 3, 4000000, 55000000, 998, '2026-09-01 07:25:13', '2026-09-11 01:57:40');
...
-- Dumping data for table posmia.users: ~4 rows (approximately)
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(11, 1, 'miasumiati', 'miamia@gmail.com', NULL, '$2y$12$TuPxN8eMm8dj9PWsaD4D2OICyL7awUAwWYtWNIyGIvYbKfjmC2ZSi', NULL, '2026-09-10 06:44:10', '2026-09-10 06:44:10'),
	(12, 2, 'Dhella', 'dhella@gmail.com', NULL, '$2y$12$7Zc9YEGZjig0.slt/LHak.qhcdbBYfxH.OtE12kFfX17.7nwoJw.i', NULL, '2026-09-11 02:09:13', '2026-09-11 02:09:13');
